...
$pdf->Cell(150, 10, iconv("UTF-8", "ISO-8859-1", strtoupper("JARK")), 0, 0, 'L');

$pdf->Ln(9);

$pdf->SetFont('Arial', '', 10);
$pdf->SetTextColor(39, 39, 51);
$pdf->Cell(150, 9, iconv("UTF-8", "ISO-8859-1", "RUC: 123456789"), 0, 0, 'L');

$pdf->Ln(5);

$pdf->Cell(150, 9, iconv("UTF-8", "ISO-8859-1", "San juan de lurigancho, Metro 8"), 0, 0, 'L');
...
$pdf->SetTextColor(97, 97, 97);
$pdf->Cell(109, 7, iconv("UTF-8", "ISO-8859-1", "San juan de lurigancho, av.el sol, cuadra25"), 0, 0);
...
$pdf->Cell(25, 7, iconv("UTF-8", "ISO-8859-1", "S/ 10 PEN"), 'L', 0, 'C');
$pdf->Cell(19, 7, iconv("UTF-8", "ISO-8859-1", "S/ 0.00 PEN"), 'L', 0, 'C');
$pdf->Cell(32, 7, iconv("UTF-8", "ISO-8859-1", "S/ 70.00 PEN"), 'LR', 0, 'C');
$pdf->Ln(7);
...
$pdf->Cell(34, 7, iconv("UTF-8", "ISO-8859-1", "+ S/70.00 PEN"), 'T', 0, 'C');
...
$pdf->Cell(34, 7, iconv("UTF-8", "ISO-8859-1", "+ S/0.00 PEN"), '', 0, 'C');
...
$pdf->Cell(34, 7, iconv("UTF-8", "ISO-8859-1", "S/ 100.00 PEN"), '', 0, 'C');
